/*! layer-v2.1 弹层组件 License LGPL   By 贤心 */
...
/*layer再次封装 by Gru*/
function laytip(obj, position, message, color) {
    var p = 2;
    switch (position) {
        case "l": //left
            p = 4;
    ...
    return layer.tips(message, obj, {
        tips: [p, color || '#78BA32']
    });
}

function laymessage(type, message, callback) {
    var t = 0;
    switch (type) {
        case "w": //warning
            t = 0;
...
function layalert(type, message, title, btn, callback) {
    var t = 0;
    switch (type) {
        case "w": //warning
            t = 0;
...
function layconfirm(message, title, btn1, callback1, btn2, callback2) {
...
function layloading(type, cont, obj, size) {
    var index;
    switch (type) {
        case "g1": //global1
            index = layer.load();
        ...
        case "g2": //global2
            index = layer.load(1);
            break;
        case "g3": //global3,cont为显示文本
            index = layer.msg(cont || "loading...",
                {
                    icon: 16,
                    time: 0,
                    shade: [0.01, '#000']
            ...
            break;
        case "a1": //area1,cont为loading颜色,obj为#id/.class/obj(jquery对象),size为loading圆点的大小(单位为px)
            index = obj || 'body';
            size = size || 15;
            var o = typeof (index) == "object" ? obj : $(obj);
            o.attr('disabled', 'disabled');
            o.css('position', 'relative');
            o.append('<div class="loaders"><div class="loader"><div class="loader-inner ball-pulse"><div style="background-color:_color_;width:_size_;height:_size_;margin-top:_size2_;"></div><div style="background-color:_color_;width:_size_;height:_size_;margin-top:_size2_;"></div><div style="background-color:_color_;width:_size_;height:_size_;margin-top:_size2_;"></div></div></div></div>'
                .replace(/_color_/g, cont || "#fff")
                .replace(/_size_/g, (size + 'px'))
                .replace(/_size2_/g, (size / 2 + 'px')));
            break;
    }
    return index;
}
...
function layclose(index) {
    if (typeof (index) == "number") {
        ...
        try {
            if (index == undefined)
                return;
            var o = typeof (index) == "object" ? index : $(index);
            o.find('div.loaders').remove();
