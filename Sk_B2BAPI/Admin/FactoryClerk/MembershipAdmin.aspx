<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembershipAdmin.aspx.cs" Inherits="DTcms.Web.admin.FactoryClerk.MembershipAdmin" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                   <a class="menu-btn"></a>
                    ...
                    <div class="r-list" style="margin-right:50%;">
                        <input type="button" class="btn-search" value="查询"  onclick="QueryGZHZ()" />
                    </div>
                </div>
            </div>
        </div>
