...
namespace Sk_B2BAPI.WxPayAPI
{
    public class WxPayApi
    {
        ...
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            ////测试url
            //string url = "https://api.mch.weixin.qq.com/sandboxnew/secapi/pay/reverse";
            //检测必填参数
            if (!inputObj.IsSet("out_trade_no") && !inputObj.IsSet("transaction_id"))
            {
        ...
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            ////测试url
            //string url = "https://api.mch.weixin.qq.com/sandboxnew/tools/shorturl";
            //检测必填参数
        ...
        */
        ...
        /// <param name="timeOut">接口超时时间</param>
        /// <returns>成功时返回，其他抛异常</returns>
        public static WxPayData CloseOrder(WxPayData inputObj, int timeOut = 30)
        {
            ////正式url
        ...
        /// 沙箱环境签名密钥,验签秘钥API
        /// </summary>
        /// <param name="inputObj">提交给验签秘钥API的参数</param>
        /// <param name="timeOut">接口超时时间</param>
        /// <returns>沙箱环境签名密钥</returns>
        public static WxPayData GetSignKey(WxPayData inputObj,int timeOut = 6)
        {
            string url = "https://api.mch.weixin.qq.com/sandboxnew/pay/getsignkey";
            if (!inputObj.IsSet("mch_id"))/*是否存在商户号*/
            {
        ...
        /// 根据编码格式生成不同的加密串
        /// </summary>
        /// <param name="code_type">编码格式</param>
