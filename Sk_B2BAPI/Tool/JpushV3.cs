...
namespace Sk_B2BAPI.Tool
{
    public class JpushV3
    {
        ...
        private readonly string AppKey = BaseConfiguration.AppKey;
        ...
        private readonly string MasterSecret = BaseConfiguration.MasterSecret;
        ...
        private readonly string ReceivedUrl = "https://api.jpush.cn/v3/received";
